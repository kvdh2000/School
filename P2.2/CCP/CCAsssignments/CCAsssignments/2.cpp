...
void draw_Mandelbrot(PPMImage & image, const unsigned width, const unsigned height, double cxmin, double cxmax, double cymin, double cymax, unsigned int max_iterations, int which)
{
	mutex mutex;
...
int main()
{
	...
	thread t1(draw_Mandelbrot, image, width, height, -2.0, 0.5, -1.0, 1.0, 50, 1);
	thread t2(draw_Mandelbrot, image, width, height, -2.0, 0.5, -1.0, 1.0, 50, 4);
	thread t3(draw_Mandelbrot, image, width, height, -2.0, 0.5, -1.0, 1.0, 50, 3);
	thread t4(draw_Mandelbrot, image, width, height, -2.0, 0.5, -1.0, 1.0, 50, 4);
